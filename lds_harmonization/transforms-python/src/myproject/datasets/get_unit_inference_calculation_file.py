...
@configure(profile=['DYNAMIC_ALLOCATION_MAX_64', 'EXECUTOR_MEMORY_MEDIUM'])
@transform_df(
    Output("ri.foundry.main.dataset.c08ef024-1bfa-4e25-88ee-762dcb689d41"),
    codesetsLookup=Input("ri.foundry.main.dataset.e670c5ad-42ca-46a2-ae55-e917e3e161b6"),
    measurements=Input("ri.foundry.main.dataset.ef6b8be5-cb53-47aa-b59b-5647d8824dc0"),
    variables=Input("ri.foundry.main.dataset.09b4a60a-3da4-4754-8a7e-0b874e2a6f2b"),
    invalidUnits=Input("ri.foundry.main.dataset.e91d2642-e865-4edb-a31d-00aa887b7c94")

)
def my_compute_function(variables, invalidUnits, measurements, codesetsLookup, ctx):
    ...
    invalidUnits = invalidUnits.select('codeset_id', 'omop_unit_concept_name').distinct()
    ...
    refDF = refDF.repartition(64, 'codeset_id')
    ...
    testDF = testDF_1.unionByName(testDF_2)
