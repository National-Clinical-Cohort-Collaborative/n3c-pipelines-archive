...
CREATE TABLE `ri.foundry.main.dataset.280f65f2-9099-4e8f-b136-2c63871b526a` TBLPROPERTIES (foundry_transform_profiles = 'EXECUTOR_MEMORY_MEDIUM, NUM_EXECUTORS_8') AS
SELECT distinct
   data_partner_id,
    macrovisit_id,
