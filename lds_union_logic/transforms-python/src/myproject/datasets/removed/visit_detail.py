...
#inputs = get_removed_inputs(domain, include_omop=True, include_pcornet=True, include_trinetx=True, include_act=True, include_pedsnet=False)
inputs = get_removed_inputs(domain, include_omop=True, include_pcornet=True, include_act=False)
