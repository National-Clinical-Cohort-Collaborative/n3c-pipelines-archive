CREATE TABLE `ri.foundry.main.dataset.1afacb02-d10f-4466-90a6-514316b2c40f`
...
WITH join_conflict_id AS (
    ...
    FROM `ri.foundry.main.dataset.6a46a32b-27da-486d-9162-a5ace12fe004` d
    LEFT JOIN `ri.foundry.main.dataset.c1da52e2-f2ec-47f7-9e60-215444ec58c0` lookup
