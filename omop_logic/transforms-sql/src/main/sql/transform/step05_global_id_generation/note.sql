CREATE TABLE `ri.foundry.main.dataset.19e13d70-3b53-4995-955d-a75d65dfbebe` AS

WITH join_conflict_id AS (
    SELECT 
        d.*
        , COALESCE(lookup.collision_bits, 0) as collision_index
    FROM `ri.foundry.main.dataset.09380fbf-ab78-4930-ab18-b492bb5cb968` d
    LEFT JOIN `ri.foundry.main.dataset.8e18a79c-a78b-4954-bd39-363dd1ffb199` lookup
...
LEFT JOIN `ri.foundry.main.dataset.ac5cba26-3e69-4aed-bf27-9a5a9f3da074` vd
