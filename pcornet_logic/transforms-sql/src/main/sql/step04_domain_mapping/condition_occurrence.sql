CREATE TABLE `ri.foundry.main.dataset.7535361b-408a-40c4-8b34-3e782fc6c8c3` AS
...
with cond_diagnosis_obsclin AS (
    ...
    LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` csrc 
        ON csrc.CDM_TBL = 'CONDITION' 
        AND csrc.CDM_TBL_COLUMN_NAME = 'CONDITION_SOURCE' 
        AND csrc.SRC_CODE = c.condition_source
    LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` cst 
