CREATE TABLE `ri.foundry.main.dataset.93dd35f5-b61d-4dac-ac0b-e5561310af58`
...
lab_result_cm as (
    ...
    LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` bloodresult
...
obs_clin as (
    ...
    FROM `ri.foundry.main.dataset.3dacc398-2418-4bd9-9dac-4a67a1e000ad` obs
        ...
        LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` xwresult
...
obsgen_lc_num as (
    ...
    SELECT patid AS site_patid, 
        ...
        data_partner_id,
        payload
    FROM `ri.foundry.main.dataset.b52c4215-d873-4931-a8a8-455282ec9a06` obg
    INNER JOIN `ri.foundry.main.dataset.05c59431-1c54-4ef8-a475-b3772d8e830f` xw 
    ...
    LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` unit
...
-- Diastolic BP
    SELECT
        ...
        payload
    FROM `ri.foundry.main.dataset.fbe7f6f9-c4de-4562-8f71-733706fbf168` v
        INNER JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` bp 
            ON bp.CDM_TBL = 'VITAL' AND bp.CDM_TBL_COLUMN_NAME = 'DIASTOLIC_BP_POSITION'
            AND bp.SRC_CODE = v.corrected_bp_position
        LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` vt 
            ON vt.CDM_TBL = 'VITAL' AND vt.CDM_TBL_COLUMN_NAME = 'VITAL_SOURCE'
            AND vt.SRC_CODE = v.vital_source
...
-- Systolic BP
    ...
    FROM `ri.foundry.main.dataset.fbe7f6f9-c4de-4562-8f71-733706fbf168` v
        INNER JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` bp 
            ...
            AND bp.SRC_CODE = v.corrected_bp_position -- v.bp_position
        LEFT JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` vt 
            ON vt.CDM_TBL = 'VITAL' AND vt.CDM_TBL_COLUMN_NAME = 'VITAL_SOURCE'
            AND vt.SRC_CODE = v.vital_source
