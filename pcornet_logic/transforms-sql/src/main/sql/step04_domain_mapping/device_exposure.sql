CREATE TABLE `ri.foundry.main.dataset.f2557c45-d0f5-42ae-a8d7-43301380be00` AS
...
(
    SELECT 
        ...
        data_partner_id,
        payload
    FROM `ri.foundry.main.dataset.b52c4215-d873-4931-a8a8-455282ec9a06` o
    LEFT JOIN `ri.foundry.main.dataset.b2c4b372-e1f1-4098-8680-50ba08658a08` ventcode_xwalk
