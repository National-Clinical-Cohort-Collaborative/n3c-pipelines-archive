CREATE TABLE `ri.foundry.main.dataset.01dd1a33-c65f-4f13-8d20-03d9093a94a2` AS
...
with encounter as (
    ...
    FROM (
        ...
        FROM `ri.foundry.main.dataset.710e7df0-575a-4b76-b799-bc0488f10e68` e
            INNER JOIN `ri.foundry.main.dataset.9cd6e457-ddf3-416a-9bad-ffc36b30fcf3` xw 
