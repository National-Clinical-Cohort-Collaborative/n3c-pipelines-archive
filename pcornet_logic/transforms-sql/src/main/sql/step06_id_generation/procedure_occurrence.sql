CREATE TABLE `ri.foundry.main.dataset.2e613386-ebaf-473b-bb6f-f4d368c9596a` AS

WITH join_conflict_id AS (
    SELECT 
        m.*
        , COALESCE(lookup.collision_bits, 0) as collision_index
    FROM `ri.foundry.main.dataset.9eaa3af1-9d8a-4186-8291-b0e45a1fb3b3` m
    LEFT JOIN `ri.foundry.main.dataset.42a16179-8fe9-4c5d-bfd1-d4e09ab7d303` lookup
