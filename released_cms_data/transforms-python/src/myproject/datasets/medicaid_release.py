...
def transform_generator(datasets):
    ...
    for dataset in datasets:
        ...
        @transform(
            out=Output("/UNITE/[PPRL] Centers for Medicare & Medicaid Services (CMS) Release/datasets/Medicaid Datasets - OMOP format/{dataset}".format(dataset=dataset.lower())),
            df=Input("/UNITE/[PPRL] CMS Data & Repository/medicaid/pipeline/staging/{inputName}".format(inputName=inputName.lower()),
...
TRANSFORMS = transform_generator(utils.MEDICAID_DATASETS_TO_RELEASE)
