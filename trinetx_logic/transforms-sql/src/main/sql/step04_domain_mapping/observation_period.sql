CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/observation_period` AS
...
with obs_period AS (
	...
	FROM (
		...
		FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/condition_occurrence`
		...
		UNION 
            ...
            FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/drug_exposure`
		    GROUP BY site_patient_id, data_partner_id, payload
		UNION 
            SELECT 
				  site_patient_id
            ...
            FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/procedure_occurrence`
	        GROUP BY site_patient_id, data_partner_id, payload
	    UNION
            SELECT 
				  site_patient_id
            ...
            FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/observation`
		    GROUP BY site_patient_id, data_partner_id, payload
		UNION 
            SELECT 
				  site_patient_id
            ...
            FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/measurement`
		    GROUP BY site_patient_id, data_partner_id, payload
		UNION 
		    SELECT 
				  site_patient_id
			...
			FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/device_exposure`
		    GROUP BY site_patient_id, data_partner_id, payload
		UNION 
			SELECT 
				  site_patient_id
		...
		UNION 
			...
			FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/death`
			GROUP BY site_patient_id, data_partner_id, payload
	) t
