CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/04.5 - deduping/observation_raw` AS 
...
WITH pat AS (
    SELECT
		...
		payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/patient` patient
...
diag_lab_proc_vital AS (
    SELECT 
        ...
        CAST(data_partner_id as int) as data_partner_id,
        payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/diagnosis` diagnosis
    ...
    SELECT
        ...
        CAST(data_partner_id as int) as data_partner_id,
        payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/lab_result` lab_result
    ...
    SELECT
        ...
        CAST(data_partner_id as int) as data_partner_id,
        payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/procedure` procedure 
    ...
    SELECT
        ...
        CAST(data_partner_id as int) as data_partner_id,
        payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/vital_signs` vital_signs 
),
...
crosswalk_lookup AS (
    ...
    INNER JOIN `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/t2o_code_xwalk_standard` crosswalk
...
value_as_concept_id_mapped AS (
    ...
    LEFT JOIN `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/sdoh_answer_code_xwalk` ansxw
...
long_covid as (
    ...
    , CAST( data_partner_id as int) as data_partner_id
    , payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/encounter` enc
...
other_records AS (
    ...
    , data_partner_id
    , payload
    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/medication` med
    INNER JOIN `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/t2o_code_xwalk_standard` xw
