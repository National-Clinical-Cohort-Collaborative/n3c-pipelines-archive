CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/note_nlp` AS	
            ...
            SELECT DISTINCT 
                * 
                , md5(concat_ws( ';'
                    ...
                    FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/note_nlp` nlp
