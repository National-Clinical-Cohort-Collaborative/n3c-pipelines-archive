CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/04 - domain mapping/control_map` AS
        ...
        FROM ( 
            SELECT DISTINCT
                ...
                from ( select distinct 
                        ...
                        payload
                        from 
                        `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: TriNetX/raw_trinetx/Site 102/transform/03 - prepared/control_map` cm
