...
@transform_df(
    Output("ri.foundry.main.dataset.0ae95727-0046-4b59-b2cc-042279c5ee6d"),
    my_input=Input("ri.foundry.main.dataset.38dcdc9f-9261-44b2-aad0-d10f147cb203", stop_propagating=Markings(LDS, on_branches=utils.release_branches)),
...
def my_compute_function(my_input, date_shifts_df):
    ...
    date_cols = ["death_date"]
    timestamp_cols = ["death_datetime"]
