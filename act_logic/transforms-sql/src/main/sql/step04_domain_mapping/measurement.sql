CREATE TABLE `ri.foundry.main.dataset.61b4488b-3eb8-40c8-8fb4-028b2cf336d0`
...
with obs_fact as (
    ...
    FROM `ri.foundry.main.dataset.b45684f1-ba10-4a41-a49b-34a80dee15c4` o
        ...
        LEFT JOIN `ri.foundry.main.dataset.965c112a-83cb-44b6-b36c-e1ba7730048c` tvqual 
