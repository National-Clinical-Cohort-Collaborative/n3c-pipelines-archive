CREATE TABLE `ri.foundry.main.dataset.c8b7634a-883a-4c7e-9b95-77a5135ffc75`
...
(
	SELECT DISTINCT
		...
		c.concept_id
	FROM `ri.foundry.main.dataset.a28856b8-6ca9-4b6c-948f-0dce0c6cbe99` ca
		INNER JOIN `ri.foundry.main.dataset.82451eb6-4185-4ff6-9d0b-5ad33d89f3f4` c ON ca.ancestor_concept_id = c.concept_id
...
(-- Normalize DRUG_EXPOSURE_END_DATE to either the existing drug exposure end date, or add days supply, or add 1 day to the start date
	SELECT
		...
		, data_partner_id
		, payload
	FROM `ri.foundry.main.dataset.42ffcb6c-bcf0-4485-af76-bb7b4c865a1b` d
