CREATE TABLE `ri.foundry.main.dataset.42ffcb6c-bcf0-4485-af76-bb7b4c865a1b` AS
...
with obs_fact as (
    ...
    FROM `ri.foundry.main.dataset.b45684f1-ba10-4a41-a49b-34a80dee15c4` ob
        ...
        LEFT JOIN `ri.foundry.main.dataset.965c112a-83cb-44b6-b36c-e1ba7730048c` rqual 
