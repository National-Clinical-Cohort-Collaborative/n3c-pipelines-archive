CREATE TABLE `ri.foundry.main.dataset.c7178829-a2f6-4af4-a236-642273ec26de` AS
...
with obs_fact as (
    ...
    SELECT DISTINCT
        ...
        data_partner_id,
        payload
    FROM `ri.foundry.main.dataset.b45684f1-ba10-4a41-a49b-34a80dee15c4` of
    LEFT JOIN `ri.foundry.main.dataset.4a1884e2-2c8e-45ea-9187-6047feee7602` xw
