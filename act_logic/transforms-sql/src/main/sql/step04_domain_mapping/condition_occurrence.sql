CREATE TABLE `ri.foundry.main.dataset.15885ef3-ce89-4ea4-aff0-b9cde9ceba2f` AS
...
with crosswalk_lookup AS (
    ...
    INNER JOIN `ri.foundry.main.dataset.4691f539-2a72-4abe-a1fa-d2f6a9cba939` crosswalk
