CREATE TABLE `ri.foundry.main.dataset.d2160c6c-0f1f-4bff-8399-3b3cc31729d8` AS

WITH join_conflict_id AS (
    SELECT 
        m.*
        , COALESCE(lookup.collision_bits, 0) as collision_index
    FROM `ri.foundry.main.dataset.42ffcb6c-bcf0-4485-af76-bb7b4c865a1b` m
    LEFT JOIN `ri.foundry.main.dataset.3cd492f4-4b4f-4970-b52b-a4e9ffe25d22` lookup
