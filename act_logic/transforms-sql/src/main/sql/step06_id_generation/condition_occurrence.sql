CREATE TABLE `ri.foundry.main.dataset.e8909b0b-f620-4895-ba5c-6987b3a96ae0` AS

WITH join_conflict_id AS (
    SELECT 
        m.*
        , COALESCE(lookup.collision_bits, 0) as collision_index
    FROM `ri.foundry.main.dataset.15885ef3-ce89-4ea4-aff0-b9cde9ceba2f` m
    LEFT JOIN `ri.foundry.main.dataset.b1a584d7-26d6-491c-9fbe-c3d87e0219c5` lookup
