CREATE TABLE `ri.foundry.main.dataset.25e0e7f1-7f5c-4e54-b082-3565804bd7e8` AS

WITH join_conflict_id AS (
    SELECT 
        m.*
        , COALESCE(lookup.collision_bits, 0) as collision_index
    FROM `ri.foundry.main.dataset.67cce63c-d550-416b-aede-614103839099` m
    LEFT JOIN `ri.foundry.main.dataset.62ed8baa-4848-406c-9246-4378b5b281ea` lookup
