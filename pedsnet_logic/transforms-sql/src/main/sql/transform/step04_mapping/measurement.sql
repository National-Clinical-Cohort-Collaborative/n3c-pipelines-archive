CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 1015/transform/04 - mapping/measurement` AS
    ...
    with measurement as (
        ...
        AND (m.target_domain_id  NOT IN ('Device', 'Observation', 'Condition','Procedure','Drug','Visit'))
    ),
