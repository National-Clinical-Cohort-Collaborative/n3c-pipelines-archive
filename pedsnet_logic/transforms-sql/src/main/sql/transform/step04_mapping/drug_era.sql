CREATE TABLE `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 1015/transform/04 - mapping/drug_era` AS
...
(-- Normalize DRUG_EXPOSURE_END_DATE to either the existing drug exposure end date, or add days supply, or add 1 day to the start date
	...
	FROM `/UNITE/Data Ingestion & OMOP Mapping/Source Data Model: PEDSnet/Site 1015/transform/04 - mapping/drug_exposure` d
		JOIN `ri.foundry.main.dataset.c5e0521a-147e-4608-b71e-8f53bcdbe03c` ca ON ca.descendant_concept_id = d.drug_concept_id
		JOIN `ri.foundry.main.dataset.5cb3c4a3-327a-47bf-a8bf-daf0cafe6772` c ON ca.ancestor_concept_id = c.concept_id
